...
import me.james.biuedittext.BounceEaseOut;

/**
 * Created by Vampire on 16/10/8.
 */
public class MyTextView extends ShimmerTextView {
    private static final String TAG = "Vampire_MyTextView";
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        final TypedArray typedArray = context.obtainStyledAttributes(attrs, me.james.biuedittext.R.styleable.BiuEditStyle);
        biuTextColor = typedArray.getColor(me.james.biuedittext.R.styleable.BiuEditStyle_biu_text_color, getResources().getColor(me.james.biuedittext.R.color.white));
        biuTextStartSize = typedArray.getDimension(me.james.biuedittext.R.styleable.BiuEditStyle_biu_text_start_size, getResources().getDimension(me.james.biuedittext.R.dimen.biu_text_start_size));
        biuTextScale = typedArray.getFloat(me.james.biuedittext.R.styleable.BiuEditStyle_biu_text_scale, DEFAULT_SCALE);
        biuDuration = typedArray.getInt(me.james.biuedittext.R.styleable.BiuEditStyle_biu_duration, DEFAULT_DURATION);
        biuType = typedArray.getInt(me.james.biuedittext.R.styleable.BiuEditStyle_biu_type, 0);
        typedArray.recycle();
